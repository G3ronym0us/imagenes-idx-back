<x-layout>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTrU9OxUToi6tQGIN9d8k0YVDJyHUzoaWrAIg&usqp=CAU" class="card-img-top" alt="...">
                <div class="card-body">
        ...
        <div class="col-md-4">
            <div class="card">
                <img src="http://aupe.org.uy/web/wp-content/uploads/2013/08/Curso-2-2013-opcion-grande.jpg" class="card-img-top" alt="...">
                <div class="card-body">
